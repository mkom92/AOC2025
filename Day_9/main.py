...
def star_2(inp_file: str, timeit = False):
    ...
    # Step 2 - Define the ray casting function that actually works

    def ray_casting(point: tuple, sides: list) -> bool:

        crossed_walls = 0

        focus_direction = 0 # -1 if left, 1 if right
        ...
        for side in sides:
            ...
            elif point[1] == side[0][1]:
                return True

            elif point[0] == side[0][0]:

                if in_out and focus_direction == 0:
                    focus_direction = -1
                    crossed_walls += 1

                elif not in_out and focus_direction == 0:
                    focus_direction = 1
                    crossed_walls += 1
                    in_out = True

                elif focus_direction == -1:
                    in_out = True
            ...
            if not in_out and crossed_walls > 0:
                return in_out
        ...
        if n == 0:
            ...
            for other_corner in corners[:n]:
                ...
                if test_1 and test_2:
                    ...
                    # If there are any "holes" in the area it does not work
